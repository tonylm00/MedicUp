...
from .views import PatientList, PatientDetail, DoctorList, DoctorDetail, ElencoFarmaciView, DettaglioFarmacoView, ReminderCreateView, DoctorReminderListView, PatientReminderListView, AggiungiFarmacoArmadiettoView, ArmadiettoView
